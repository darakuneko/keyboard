...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    <,       >,       MT(MOD_LSFT, KC_SCLN),
		KC_LGUI, KC_LALT, KC_NO,   LT(1, KC_SPC),LT(1, KC_BSPC),KC_NO,   KC_RALT, KC_RGUI
	),
	...
	[1] = LAYOUT(
		...
		KC_NO,   MO(3),   MO(2),   KC_LSFT, KC_LSFT, MO(2),   MO(3),   KC_NO
	),
