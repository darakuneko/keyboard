...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_HENK,             KC_LGUI, KC_LCTL, KC_LALT, MO(2),   MO(1),      KC_SPC,        KC_BSPC,   MO(1),   KC_LEFT, KC_DOWN, KC_RGHT
  ),

  [1] = LAYOUT(
    KC_GRV,    KC_1,       KC_2,       KC_3,       KC_4,       KC_5,                 KC_6,      KC_7,       KC_8,      KC_9,      KC_0,      KC_MINS,    KC_EQL, \
    S(KC_GRV), S(KC_1),    S(KC_2),    S(KC_3),    S(KC_4),    S(KC_5),             S(KC_6),    S(KC_7),    S(KC_8),   S(KC_9),   S(KC_0),   S(KC_MINS), S(KC_EQL), \
    KC_F1,     KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,               KC_F7,      KC_F8,      KC_F9,     KC_F10,    KC_F11,    KC_F12,     MO(6), \
  ...
  [3] = LAYOUT(
    ...
    MT(MOD_LCTL,KC_TAB), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_BSLS, \
    KC_LSFT,             KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_UP, KC_ENT, \
    KC_HENK,             KC_LGUI, KC_LCTL, KC_LALT, MO(5),   MO(4),      KC_SPC,        KC_BSPC,   MO(4),   KC_LEFT, KC_DOWN, KC_RGHT
  ),
