...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
	...
	[3] = LAYOUT(
		RGB_VAI,  RGB_SAI,    RGB_HUI,    RGB_SPI,   RGB_MOD,    RGB_TOG,  KC_NO,   KC_NO,   KC_NO,  QK_BOOT,   KC_NO,   KC_NO, 
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) { 
  ...
  if (accel_speed == 0.25) {
    ...
    rgb_matrix_set_color(19, rgb_speed.r, rgb_speed.g, rgb_speed.b);
    rgb_matrix_set_color(20, rgb_speed.r, rgb_speed.g, rgb_speed.b);
    rgb_matrix_set_color(21, rgb_speed.r, rgb_speed.g, rgb_speed.b);

    rgb_matrix_set_color(31, rgb_speed.r, rgb_speed.g, rgb_speed.b); 
    rgb_matrix_set_color(32, rgb_speed.r, rgb_speed.g, rgb_speed.b); 
    rgb_matrix_set_color(33, rgb_speed.r, rgb_speed.g, rgb_speed.b);  
    ...
    rgb_matrix_set_color(21, rgb_speed.r, rgb_speed.g, rgb_speed.b);
    rgb_matrix_set_color(22, rgb_speed.r, rgb_speed.g, rgb_speed.b);

    rgb_matrix_set_color(33, rgb_speed.r, rgb_speed.g, rgb_speed.b);
    rgb_matrix_set_color(34, rgb_speed.r, rgb_speed.g, rgb_speed.b);
    ...
    rgb_matrix_set_color(21, rgb_speed.r, rgb_speed.g, rgb_speed.b);
    rgb_matrix_set_color(22, rgb_speed.r, rgb_speed.g, rgb_speed.b);
    rgb_matrix_set_color(23, rgb_speed.r, rgb_speed.g, rgb_speed.b);

    rgb_matrix_set_color(33, rgb_speed.r, rgb_speed.g, rgb_speed.b);
    rgb_matrix_set_color(34, rgb_speed.r, rgb_speed.g, rgb_speed.b);
    rgb_matrix_set_color(35, rgb_speed.r, rgb_speed.g, rgb_speed.b);
  }
  ...
  if (accel_step == 1) {
    ...
    rgb_matrix_set_color(24, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(36, rgb_step.r, rgb_step.g, rgb_step.b);
  } else if (accel_step == 2) {
    rgb_matrix_set_color(12, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(13, rgb_step.r, rgb_step.g, rgb_step.b);

    rgb_matrix_set_color(24, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(25, rgb_step.r, rgb_step.g, rgb_step.b);

    rgb_matrix_set_color(36, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(37, rgb_step.r, rgb_step.g, rgb_step.b);
    ...
    rgb_matrix_set_color(24, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(25, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(26, rgb_step.r, rgb_step.g, rgb_step.b);

    rgb_matrix_set_color(36, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(37, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(38, rgb_step.r, rgb_step.g, rgb_step.b);
  } else if (accel_step == 8) {
    rgb_matrix_set_color(12, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(13, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(14, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(15, rgb_step.r, rgb_step.g, rgb_step.b);

    rgb_matrix_set_color(24, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(25, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(26, rgb_step.r, rgb_step.g, rgb_step.b);
    rgb_matrix_set_color(27, rgb_step.r, rgb_step.g, rgb_step.b);
  ...
  if (phase != POMODORO_IDLE) {
    switch (phase) {
      ...
      case POMODORO_BREAK: // Green
        ...
        rgb_matrix_set_color(46, 0, 255, 0);
      ...
      case POMODORO_LONG_BREAK: // Blue
        ...
        rgb_matrix_set_color(47, 0, 0, 255);
        break;
      case POMODORO_IDLE:
      default:
        break;
