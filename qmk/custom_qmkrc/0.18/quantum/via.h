...
enum via_command_id {
    ...
    id_qmk_rc_olde_off                      = 0x65,
    id_qmk_rc_olde_on                       = 0x66,
    id_qmk_rc_olde_write                    = 0x67,
    id_qmk_rc_olde_clear                    = 0x68,
    id_qmk_rc_rgblight_off                  = 0x69,
    id_qmk_rc_rgblight_on                   = 0x6a,
    id_qmk_rc_rgblight_setrgb_range         = 0x6b,
    id_qmk_rc_rgb_matrix_off                = 0x6c,
    id_qmk_rc_rgb_matrix_on                 = 0x6d,
    id_qmk_rc_rgb_matrix_setrgb_range       = 0x6e,
    id_qmk_rc_layer_on                      = 0x6f,
    id_qmk_rc_layer_off                     = 0x70,
    id_qmk_rc_layer_clear                   = 0x71,
    id_qmk_rc_layer_move                    = 0x72,
    id_qmk_rc_sned_string                   = 0x73,
    id_qmk_is_olde_on                       = 0x74,
