...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [0] = LAYOUT(
    ...
    KC_LCTL, KC_LALT, KC_MENU, JP_MHEN,          KC_SPC,           JP_HENK, JP_KANA, KC_RALT, KC_RCTL, MO(1) 
  ),
 ...
 [1] = LAYOUT(  
    ...
    _______, _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______, _______, \
    MO(2), KC_LGUI,    _______,    _______,    _______,          _______,          _______,    _______,    KC_RGUI,    _______\
  ),
 ...
 [3] = LAYOUT(
    ...
    KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    JP_SCLN, JP_COLN, JP_RBRC, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    JP_COMM, JP_DOT,  JP_SLSH, JP_BSLS, KC_RSFT, \
    KC_LCTL, KC_LALT, KC_MENU, JP_MHEN,          KC_SPC,           JP_HENK, JP_KANA, KC_RALT, KC_RCTL, MO(3)
  ),
 ...
 [4] = LAYOUT(  
    ...
    _______, _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______, _______, \
    _______, _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______, _______, \
    MO(5), KC_LGUI,    _______,    _______,    _______,          _______,          _______,    _______,    KC_RGUI,    _______\
  ),
