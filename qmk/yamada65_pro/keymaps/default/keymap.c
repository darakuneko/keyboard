...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [0] = LAYOUT(
    ...
    KC_LALT, KC_MENU, JP_MHEN, MO(1),         KC_SPC,          MO(1), JP_HENK, JP_KANA, KC_RALT, KC_RCTL
  ),
 ...
 [1] = LAYOUT(  
    ...
    MO(4), KC_LGUI,    _______,    _______,    _______,          _______,          _______,    _______,    KC_RGUI,    _______\
  ),
 ...
 [2] = LAYOUT(
    ...
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    JP_SCLN, JP_COLN, JP_RBRC, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    JP_COMM, JP_DOT,  JP_SLSH, JP_BSLS, KC_RSFT, \
    KC_LALT, KC_MENU, JP_MHEN, MO(3),         KC_SPC,          MO(3), JP_HENK, JP_KANA, KC_RALT, KC_RCTL
  ),
 ...
 [4] = LAYOUT(
    DT_PRNT,  DT_UP,    DT_DOWN,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______, _______,  _______, EEP_RST,\
