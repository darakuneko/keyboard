...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [0] = LAYOUT(
    ...
    KC_LSFT,             KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    JP_COMM, JP_DOT,  JP_SLSH, JP_BSLS, KC_RSFT,
                         KC_LALT, KC_LGUI, MO(1),            KC_SPC,           MO(1),   JP_KANA, KC_RALT
  ),
 ...
 [2] = LAYOUT(
    ...
    KC_NO,  RGB_VAI,    RGB_SAI,    RGB_HUI,    RGB_SPI,    RGB_MOD,    RGB_TOG,    DT_PRNT,    DT_UP,      DT_DOWN,    KC_NO,     KC_NO,   KC_NO, QK_BOOT,
    KC_NO,  RGB_VAD,    RGB_SAD,    RGB_HUD,    RGB_SPD,    RGB_RMOD,   KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,     KC_NO,   KC_NO,
             KC_NO,     KC_NO,      KC_NO,          EEP_RST,            KC_NO,      KC_NO,      KC_NO  
 ),
