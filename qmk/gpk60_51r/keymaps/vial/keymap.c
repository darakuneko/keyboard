...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    MT(MOD_LSFT,KC_F1),     KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,               KC_F7,      KC_F8,      KC_F9,     KC_F10,    KC_F11,    MT(MOD_LSFT,KC_F12),    \
    _______,   _______,    _______,    MO(3),    _______,          _______,                   _______,   _______,   _______,   _______,   _______,    _______
  ),
  ...
  [3] = LAYOUT(
    ...
    RGB_VAD,  RGB_SAD,    RGB_HUD,    RGB_SPD,   _______,    _______,         _______,    _______,    _______,    _______,    _______,    _______, _______, \
    _______,  _______,     _______,    _______,    _______,    _______,         _______,    _______,    _______,    _______,    _______,    _______, \
