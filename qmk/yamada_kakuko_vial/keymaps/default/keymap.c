...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS, KC_RSFT, KC_P1,   KC_P2,   KC_P3,
		MO(1),   KC_LGUI, KC_LALT, KC_DEL,  LT(1, KC_SPC),KC_ENT,  KC_NO,   KC_RALT, KC_RGUI, KC_RGUI, MO(2),   KC_P0,   KC_PDOT, KC_PENT
	),
	...
	[1] = LAYOUT(
		...
		KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
		KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_UP,   KC_NO,
		KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   LT(1, KC_ENT),KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_RIGHT,KC_DOWN, KC_LEFT
	),
