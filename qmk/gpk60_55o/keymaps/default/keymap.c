...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
    ...
    KC_HENK,             KC_LGUI, KC_LCTL, MO(2),   MO(1),      KC_SPC,        KC_BSPC,   MO(1),  MO(2),  KC_LALT,  KC_LEFT, KC_DOWN, KC_RGHT
  ),
 ...
 [_LOWER] = LAYOUT(
    ...
    KC_MHEN,  _______,    _______,    _______,     MO(3),          _______,   _______,           _______,   MO(3),    _______,        _______, _______, _______
  ),
