...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [1] = LAYOUT(  
    ...
    _______, _______,    _______,    _______,    _______,          _______,          _______,    _______,    _______,    _______,    MO(4),   _______,                  _______, _______, _______\
  ),        
 ...
 [2] = LAYOUT(
    ...
    KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    JP_SCLN, JP_COLN, JP_RBRC, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    JP_COMM, JP_DOT,  JP_SLSH, JP_BSLS, KC_RSFT,                    KC_UP,\
    KC_LCTL, KC_LGUI, KC_LALT, KC_MENU, JP_MHEN,          KC_SPC,           JP_HENK, JP_KANA, KC_RALT, KC_RGUI, KC_RCTL, MO(3),    KC_LEFT, KC_DOWN, KC_RGHT
  ),
