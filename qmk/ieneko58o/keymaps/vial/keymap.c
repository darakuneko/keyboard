...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		MO(2), KC_LCTL, KC_LALT, KC_LGUI, LT(1, KC_SPC), LT(1, KC_BSPC), KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT
	),
	...
	[1] = LAYOUT(
		...
		XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LSFT, KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
	),
