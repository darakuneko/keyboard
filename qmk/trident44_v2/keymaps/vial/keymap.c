...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [0] = { ENCODER_CCW_CW(C(KC_VOLD), C(KC_VOLU)),  ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [1] = { ENCODER_CCW_CW(C(KC_VOLD), C(KC_VOLU)),  ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [2] = { ENCODER_CCW_CW(C(KC_VOLD), C(KC_VOLU)),  ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [3] = { ENCODER_CCW_CW(C(KC_VOLD), C(KC_VOLU)),  ENCODER_CCW_CW(KC_VOLD, KC_VOLU) }
};
