...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LBRC, KC_RBRC, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, MT(MOD_LSFT, KC_SCLN), 
		KC_LALT, KC_LGUI, MO(1), KC_SPC, KC_ENT, LT(1, KC_BSPC), KC_RGUI, KC_RALT
	),
	...
	[1] = LAYOUT(
		...
		KC_NO, KC_NO, KC_LSFT, MO(2),  MO(2), KC_RSFT, KC_NO, KC_NO
	),

	[2] = LAYOUT(
		KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_NO, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, 
		RGB_TOG, RGB_VAI, RGB_SAI, RGB_HUI, RGB_SPI, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
