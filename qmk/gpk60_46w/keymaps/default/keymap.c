...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    KC_F1,     KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,    S(KC_MINS),      S(KC_EQL), KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  \
                                 KC_MHEN, KC_LALT, MO(6),    KC_TRNS,         KC_TRNS,    KC_DEL,  MO(6),   KC_TRNS                     \
  ),
  ...
  [3] = LAYOUT(
    ...
    MT(MOD_LCTL,KC_TAB), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                            KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,  \
    KC_LSFT,             KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_LBRC,       KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  \
                                           KC_HENK, MO(5),   MO(4),  KC_SPC,        KC_ENT,   KC_BSPC, MO(4),    MO(5)                      \
  ),
  ...
  [6] = LAYOUT(
    RGB_VAI,  RGB_SAI,    RGB_HUI,    RGB_SPI,    RGB_MOD,    RGB_TOG,                                 _______,    _______,    _______,    _______,    _______, _______, \
    RGB_VAD,  RGB_SAD,    RGB_HUD,    RGB_SPD,   RGB_RMOD,    _______,                                 _______,    _______,    _______,    _______,    _______, _______, \
