...
#define PRODUCT_ID   0x1522
#define DEVICE_VER   0x0001
#define MANUFACTURER Daraku-Neko
#define PRODUCT      Yamada Shozo
 ...
 *
 */
#define MATRIX_COL_PINS { A0, A1, A2, A3, A4, A5, A6, B13, B12 }
#define MATRIX_ROW_PINS { B7, B6, B5, B4, B3, A15, B15, B14, A10 }
#define UNUSED_PINS
