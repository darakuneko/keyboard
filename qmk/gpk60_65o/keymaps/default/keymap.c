...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
    ...
    KC_LALT,  KC_LGUI, KC_HENK, MO(2),   MO(1),   KC_SPC,  KC_ENT,  MO(1),   MO(2),   KC_MHEN, KC_LEFT, KC_DOWN, KC_RGHT
  ),
 ...
 [_LOWER] = LAYOUT(
    ...
    _______,  _______,    _______,    _______,    _______,  RESET,      _______,    _______,    MO(3),      _______,    _______,    _______, _______
  ), 
     
[_RAISE] = LAYOUT(
    KC_A,  _______,    _______,    _______,    _______,  _______,    _______,    _______,    _______,    _______,    _______,    _______, _______,  \
