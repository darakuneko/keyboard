...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT(
		...
		START_COLOR_LAYER, SET_COLOR_LAYER0, SET_COLOR_LAYER1, SET_COLOR_LAYER2, SET_COLOR_LAYER3, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT,
